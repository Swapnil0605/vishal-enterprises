export const servicesData = [
    {
        ...
        standards: ['ISO 9001:2015', 'IP55 / IP65 Ingress Protection', 'IEC 61439 Compliance', 'GeM OEM Accredited'],
        image: '/images/products/AC Sequential Control Panel.jpeg',
        accentImage: '/images/products/ATS Control Panel.jpeg',
        alt: 'Customised Industrial Automation Panel'
    },
    {
        id: 'plc-process',
        ...
        fullTitle: 'PLC Panels and Process Controls',
        category: 'Automation & Controls',
        shortDesc: 'SCADA and PLC integration for automated continuous batching, pipeline sequencing, and process flow control.',
        detailedDesc: 'Our Programmable Logic Controller (PLC) and Supervisory Control and Data Acquisition (SCADA) panels deliver precise process automation for continuous and batch operations. We provide turn-key programming, human-machine interface (HMI) screen development, telemetry networking, and fail-safe automated shutdowns for high-consequence industrial facilities.',
        features: [
        ...
        standards: ['ISO 9001:2015', 'IEC 61131-3 Programming', 'IEEE 802.3 Ethernet', 'Class-1 Licensed'],
        image: '/images/products/RO Utility Control Panel.jpeg',
        accentImage: '/images/products/ATS Controller.jpeg',
        alt: 'PLC Process Control Panel'
    },
    {
        ...
        fullTitle: 'Fire Engine and Jockey Pump Control Panels',
        ...
        standards: ['OISD-117 Standard Compliance', 'NFPA 20 Design Guidelines', 'ISO 9001:2015 Certified', 'GeM Accredited'],
        image: '/images/products/Fire Pump Duty Control Panel.jpeg',
        accentImage: '/images/products/Fire Pump Fail Safe Sequencing Logic Panel.jpeg',
        alt: 'Fire Pump Duty Control Panel'
    },
    {
        id: 'vfd-pmcc-ro',
        ...
        fullTitle: 'VFD, FASD, PMCC Panels, and RO Utility Panels',
        ...
        detailedDesc: 'Our Power and Motor Control Centers (PMCC), Variable Frequency Drive (VFD) panels, and Fully Automatic Star-Delta (FASD) starters provide robust energy management and reliable motor protection for heavy industrial loads. From municipal water utilities to heavy machinery plants, our switchgear delivers smooth acceleration, harmonic mitigation, and optimal power factor.',
        features: [
        ...
        standards: ['IEC 61439-1/2', 'IS 8623 Standards', 'ISO 9001:2015', 'Class-1 Licensed'],
        image: '/images/products/CNG panel and Thyristor controlled APFC PAN.jpeg',
        accentImage: '/images/products/ACB Servicing and Maintenance.jpeg',
        alt: 'VFD PMCC Control Panel'
    },
    {
        id: 'siren-dyke',
        ...
        fullTitle: 'Siren Control Panels and Dyke Valve Position Panels',
        ...
        detailedDesc: 'Designed to safeguard hazardous storage environments, our Dyke Valve Position Monitoring and Emergency Siren Control Panels provide real-time status indication of containment valves in petroleum tank farms. Equipped with explosion-proof limit switches, audio-visual alarms, and wireless telemetry, they prevent hazardous chemical containment breaches.',
        features: [
        ...
        standards: ['OISD-117 & OISD-118', 'PESO Certified Flameproof', 'ISO 9001:2015', 'IP66 Rated'],
        image: '/images/products/Dyke Valve Position Annunciation Panel.jpeg',
        accentImage: '/images/products/Dyke Valve Sensor Switch.jpeg',
        alt: 'Dyke Valve Position Annunciation Panel'
    },
    {
        id: 'fire-alarm',
        ...
        fullTitle: 'Fire Alarm (Smoke and Heat Detection) Panels',
        ...
        standards: ['IS 2189 Compliance', 'NFPA 72 Standards', 'ISO 9001:2015', 'GeM Accredited'],
        image: '/images/products/Fire Alarm Control Panel.jpeg',
        accentImage: '/images/products/Flameproof Fire Alarm Control Panel.jpeg',
        alt: 'Fire Alarm Detection Panel'
    },
    {
        id: 'flp-gas',
        slug: 'flp-gas-detection-simulation',
        num: '07',
        title: 'FLP Gas Detection & Simulation',
        fullTitle: 'Flameproof (FLP) Gas Detection and Simulation Panels',
        ...
        standards: ['IS/IEC 60079-0/1 (Ex d Flameproof)', 'PESO Certified', 'OISD-117 Compliant', 'ISO 9001:2015'],
        image: '/images/products/Gas Detection Controller with Bluetooth control.jpeg',
        accentImage: '/images/products/Gas Detection Controller.jpeg',
        alt: 'FLP Gas Detection Controller'
    },
    {
        id: 'flp-earthing',
        slug: 'flp-earthing-relay-monitoring',
        num: '08',
        title: 'FLP Earthing Relay & Monitoring',
        fullTitle: 'FLP Earthing Relay Units and TT DP Switch Monitoring',
        category: 'Hazardous Area',
        shortDesc: 'Static earthing interlock relays with decantation pump interlocking and tank truck discharge safety monitoring.',
        detailedDesc: 'Our Flameproof Static Earthing Interlock Relay Units ensure safe decantation of flammable volatile liquids by constantly verifying ground continuity and electrostatic charge dissipation before allowing decantation pumps to start. Incorporating Tank Truck (TT) DP switch monitoring to eliminate static spark hazards during tanker loading and unloading.',
        features: [
        ...
        standards: ['IS/IEC 60079-11 (Intrinsically Safe)', 'PESO Approved', 'OISD-118 Standards', 'ISO 9001:2015'],
        image: '/images/products/New product launched. FLP Earthing Relay interlocking with decantation  delivery pump..jpeg',
        accentImage: '/images/products/Flameproof Dyke Valve Position Control Pane.jpeg',
        alt: 'FLP Earthing Relay Unit'
    },
    {
        ...
        fullTitle: 'Automatic Battery Changeover Panels',
        ...
        standards: ['ISO 9001:2015 Certified', 'OISD-117 Fire Guidelines', 'IEEE 450 Standards', 'GeM Accredited'],
        image: '/images/products/Automatic Battery Changeover Panel.jpeg',
        accentImage: '/images/products/Graphical LCD Panel.jpeg',
        alt: 'Automatic Battery Changeover Panel'
    },
    {
        id: 'wti-oti',
        slug: 'wti-oti-safety-alarms-simulation',
        num: '10',
        title: 'WTI / OTI & Live Simulation',
        fullTitle: 'WTI / OTI and Safety Alarms Live Simulation',
        category: 'Transformer Instrumentation',
        ...
        standards: ['IS 3639 Compliance', 'IEC 60076-2 Standards', 'ISO 9001:2015', 'Class-1 Licensed'],
        image: '/images/products/Tank Level Annunciation Panel for Oil Industries.jpeg',
        accentImage: '/images/products/Transformer Filtration  Leakage arrest etc.jpeg',
        alt: 'WTI OTI Safety Simulation Panel'
    },
    {
        ...
        fullTitle: 'Energy Saving Panels and Alarm Annunciation Panels',
        ...
        standards: ['IS 13340 Compliance', 'IEC 60831 Standards', 'ISO 9001:2015', 'GeM Accredited'],
        image: '/images/products/Graphical LCD Panel.jpeg',
        accentImage: '/images/products/CNG panel and Thyristor controlled APFC PAN.jpeg',
        alt: 'Energy Saving Annunciation Panel'
    },
    {
        id: 'data-comm',
        ...
        fullTitle: 'Data Communication Systems (Wireless and Modbus RTU / TCP)',
        ...
        detailedDesc: 'Vishal Enterprises provides comprehensive plant telemetry and industrial IoT communication infrastructure. We bridge field instrumentation with centralized control systems using ruggedized industrial Modbus RTU/TCP gateways, long-range wireless telemetry, fiber-optic converters, and secure cloud monitoring.',
        features: [
        ...
        standards: ['Modbus Organization Certified', 'IEEE 802.15.4 / BLE', 'ISO 9001:2015', 'Class-1 Licensed'],
        image: '/images/products/Advanced Fire Pump Control Panel.jpeg',
        accentImage: '/images/products/SOP Narrator.jpeg',
        alt: 'Data Communication Controller'
    },
    {
        id: 'ht-works',
        slug: 'ht-works-substation-tests',
        num: '13',
        title: 'HT Works & Sub-Station Tests',
        fullTitle: 'High Tension (HT) Works and Tests (Transformer, VCB, ACB, and Mats)',
        category: 'High Tension Services',
        shortDesc: 'Comprehensive high-tension sub-station testing, circuit breaker timing analysis, and transformer oil filtration services.',
        detailedDesc: 'As a licensed Class-1 Electrical Contractor, Vishal Enterprises executes full-scope High Tension (HT) sub-station works up to 33kV/66kV. Our services include transformer erection, high-vacuum oil dehydration & filtration, Vacuum Circuit Breaker (VCB) overhaul, busbar insulation tests, and dielectric safety mat installation.',
        features: [
            'Vacuum Circuit Breaker (VCB) contact timing and dynamic resistance testing',
            'Transformer oil filtration, degassing, moisture removal, and BDV restoration',
            'Air Circuit Breaker (ACB) primary and secondary current injection calibrations',
            'Substation earth pit resistance testing and grid network enhancement',
            'High-voltage insulation resistance (Megger) and Hi-Pot dielectric testing',
            'Supply and testing of statutory high-voltage electrical insulating safety mats'
        ],
        applications: [
            'High-Voltage 11kV / 22kV / 33kV Sub-Stations',
            'Industrial Heavy Power Incomer Switchyards',
            'Petrochemical & Refinery Substation Maintenance',
            'Steel Mills & Heavy Induction Furnaces',
            'Renewable Energy Grid Interconnection Yards'
        ],
        standards: ['Government Class-1 Licensed Contractor', 'IS 2026 / IS 1866', 'ISO 9001:2015', 'Central CEA Regulations'],
        image: '/images/products/Transformer Filtration  Leakage arrest etc.jpeg',
        accentImage: '/images/products/VCB Servicing and Maintenance.jpeg',
        alt: 'Transformer Filtration and HT Works'
    },
    {
        id: 'display-panels',
        ...
        fullTitle: 'P4 and P6 LED Display Panels (Accident-Free Days)',
        ...
        detailedDesc: 'We manufacture industrial-grade P4 and P6 full-color outdoor LED display systems engineered to promote safety awareness across industrial complexes. Displaying automatic counting of "Accident-Free Days", real-time weather metrics, production figures, and live plant environmental announcements.',
        features: [
        ...
        standards: ['IP65 Weatherproof Certified', 'ISO 9001:2015', 'CE Certified LED Drivers', 'GeM Accredited'],
        image: '/images/products/Accident Free Days Display.jpeg',
        accentImage: '/images/products/Flameproof SOP Narrator Panel.jpeg',
        alt: 'Accident Free Days Display Panel'
    },
    {
        id: 'testing-services',
        slug: 'testing-thermography-services',
        num: '15',
        title: 'Testing & Thermography Services',
        fullTitle: 'Testing and Field Services (Thermography, Relay Testing, etc.)',
        category: 'Field Engineering',
        shortDesc: 'Infrared thermal imaging audits, secondary injection numerical relay testing, calibration, and statutory safety certifications.',
        detailedDesc: 'Our specialized testing division provides predictive and preventive electrical health audits. Utilizing calibrated secondary injection test kits, numerical relay test software, and calibrated infrared thermographic cameras to pinpoint loose joints, thermal overloads, and relay calibration drift before failures occur.',
        features: [
            'Infrared thermography audits of live switchboards, transformers, and cables',
            'Numerical and electromechanical protection relay secondary injection testing',
            'Overcurrent, Earth Fault, Differential, and Distance protection curve verification',
            'Current Transformer (CT) ratio, polarity, and excitation curve testing',
            'Comprehensive statutory test reports and electrical inspectorate certifications',
            'Residual life assessment (RLA) and condition monitoring of legacy switchgear'
        ],
        applications: [
            'Annual Electrical Safety Compliance Audits',
            'Preventive Shutdown Maintenance Testing',
            'Petroleum & Chemical Plant Turnaround Audits',
            'Substation Commissioning Proof Testing',
            'Insurance & Fire Hazard Risk Auditing'
        ],
        standards: ['NABL Calibrated Test Instruments', 'CEA Safety Regulations 2010', 'ISO 9001:2015', 'Class-1 Contractor'],
        image: '/images/products/Relay Testing Services.jpeg',
        accentImage: '/images/products/Relay Testing Services (2).jpeg',
        alt: 'Relay Testing and Thermography'
    },
    {
        id: 'amc-sitc',
        ...
        fullTitle: 'AMC, SITC (Supply, Installation, Testing & Commissioning), and Material Trading',
        category: 'Turnkey Contracts',
        shortDesc: 'Single-window Supply, Installation, Testing, and Commissioning (SITC), comprehensive annual maintenance contracts, and industrial supplies.',
        ...
        features: [
            'End-to-end SITC turnkey responsibility from drawing approval to energization',
            'Annual Maintenance Contracts (AMC) with guaranteed SLA response times',
            'Authorized trading and supply of switchgear, relays, meters, and industrial cables',
            'Dedicated 24/7 emergency breakdown engineering response teams',
            'Statutory government liaisoning and Electrical Inspector approval handling',
            'Retrofitting and life-extension modernization of obsolete switchboards'
        ],
        applications: [
            'Turnkey Substation & Plant Electrification Projects',
            'Continuous Industry Comprehensive Maintenance AMCs',
            'Industrial Plant Modernization & Revamping',
            'Government Infrastructure & Public Sector Undertakings',
            'Commercial Facilities & Hospital Power Management'
        ],
        standards: ['Government Licensed Class-1 Contractor', 'ISO 9001:2015 Certified', 'GeM Accredited OEM', 'MSME Registered'],
        image: '/images/products/Services.jpeg',
        accentImage: '/images/products/VCB Servicing and Maintenance.jpeg',
        alt: 'Turnkey SITC and AMC Services'
    }
];

export const allServicesList = servicesData.map(item => item.fullTitle);

// Get single service by slug helper
export const getServiceBySlug = (slug) => {
    return servicesData.find(item => item.slug === slug) || servicesData[0];
};
